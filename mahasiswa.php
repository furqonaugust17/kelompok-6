    ...
    ?>
        ...
        <form action="<?= $url; ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input class="form-check-input" type="radio" value="L" name="gender" id="laki-laki" <?= $data != null && $data['gender'] == 'L' ? 'checked' : ''; ?>>
                <label class="form-check-label" for="laki-laki">
                    Laki-Laki
                </label>
                <input class="form-check-input" type="radio" value="P" name="gender" id="perempuan" <?= $data != null && $data['gender'] == 'P' ? 'checked' : ''; ?>>
